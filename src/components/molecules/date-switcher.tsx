...
import { isValidDate, shiftDate, todayET } from "@/lib/ui/board-layout";

export type DateSwitcherProps = { date: string; onChange: (date: string) => void };

/** ← Today → plus a native date input; drives the board's `?date=`. */
