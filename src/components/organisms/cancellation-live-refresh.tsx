...
export type CancellationLiveRefreshProps = { types?: readonly string[] };
 ...
 */
export function CancellationLiveRefresh({ types = TYPES as readonly string[] }: CancellationLiveRefreshProps) {
